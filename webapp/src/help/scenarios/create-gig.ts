 ...
 * it is `disabled` when the gig being edited already has follow-ups of
 * its own, and a `gig-parent-select-blocked` line under it explains
 * why (GigEdit.tsx's fifth rule). Neither state is reachable
