      ...
      branches: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              title: "Status",
              description:
                "lead → confirmed → completed → delivered, and it drives real behaviour, not just a label. A lead never blocks time on your public availability page and never reaches Google Calendar — it's an offer, not a commitment; confirmed does both. Completed means the work is done; delivered means it has been handed over. Both are still owed and both still block the time — the difference is the dashboard's \"To deliver\" tile, which counts what is finished but not yet handed over, so a gig drops off it the moment you mark it delivered. Delivered is only offered for clients whose work needs delivering — the \"Work for this client needs delivering\" switch on the client form, which starts from \"My clients expect delivery afterwards\" in Settings — and the tile counts only that work; on any other gig the list stops at completed — for those clients, completed is the last step and its badge turns green. Cancelled pulls the gig out of your calendar, your availability and your reports without deleting the record. Whether it has actually been PAID is not on this list and not yours to set: it is added up from the payments recorded against the gig, further down this screen.",
            },
            {
              action: "highlight",
